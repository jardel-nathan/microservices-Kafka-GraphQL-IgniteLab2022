...
@Module({
  imports: [
    ...
    GraphQLModule.forRoot<ApolloFederationDriverConfig>({driver: ApolloFederationDriver,autoSchemaFile: path.resolve(process.cwd(), 'src/schema.gql')}) // path to schema  file created by graphql-code-generator
],
  providers: [
    // Resolvers
    ProductsResolver,
